...
class SoundWindow(tk.Toplevel):
    ...
    def fill_window(self):
        ...
        self.name_window_entry = tk.Entry(master=self.name_window_frame)
        ...
        self.sound_window_entry = tk.Entry(master=self.sound_window_frame)
        ...
        self.sound_window_button = tk.Button(master=self.sound_window_frame, image=self.folder_img)
